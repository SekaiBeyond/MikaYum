  ...
  "fixed z-50 gap-4 bg-background shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300 flex flex-col",
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 max-h-[90vh] border-t rounded-t-2xl data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col gap-1 px-5 pt-6 text-left", className)}
    {...props}
  />
);
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "sticky bottom-0 flex flex-col gap-2 border-t border-border bg-background px-5 py-4",
      className,
    )}
    {...props}
  />
